...
//    WalkTiaoxing walkTiaoxing = new WalkTiaoxing();
    ...
    private void initPaint() {
        ...
        shadowPaint.setColor( Color.parseColor( "#17CAAA" ) );
        ...
        circlePaint.setColor( Color.parseColor( "#17CAAA" ) );
        ...
        scorePaint.setColor( Color.parseColor( "#17CAAA" ) );
...
////        dataList=slist;
    ...
    private void drawLine(Canvas canvas) {
        ...
        //60
        text = "5000";
        float y = (sumHeight - (oneHeight * 60000));
        ...
        //100
        text = "10000";
        float y2 = (sumHeight - (oneHeight * 100000));
    ...
    private void drawBottomLine(Canvas canvas) {
        ...
        canvas.drawLine( 0, sumHeight - dp2px( 15 ) - rect.height() / 4, sumWidth, sumHeight - dp2px( 15 ) - rect.height() / 2, scorePaint );//画底部灰线
    }
